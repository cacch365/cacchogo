...
const UUID = process.env.UUID || 'a54828b2-a75c-48e3-b0a2-11a6a9b202e1'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || '';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'cacchoga.cacch336.dpdns.org';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiMmMxMGI4NWNkNzE2ZjQ4YmEwNDk3ZTkxMTgzYzhhNmMiLCJ0IjoiN2Q0MGI3OTMtMDNlMC00NTI5LWFmOWQtZmIwZmQ5OGUxMDBiIiwicyI6Ik0yTTVaREpoTm1FdFl6aGxNQzAwWmpBNExXRTVNalF0WlRBd05qY3lZVEV5WkRGayJ9
...
const NAME = process.env.NAME || 'cacchago';                        // 节点名称
